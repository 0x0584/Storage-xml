...
namespace Core.Printing
{
    class Printing
    {
        ...
        private static PrintDocument printDoc = new PrintDocument( );  // PrintDocumnet Object used for printing
        ...
        public static void DataGridView2Print( DataGridView dgv1 )
        {
        ...
        private static void BeginPrint( object sender, PrintEventArgs e )
        {
            try {
                ...
                foreach( DataGridViewColumn GridCol in dgv.Columns ) {
                    ...
                    if( !Printing.SelectedColumns.Contains( GridCol.HeaderText ) ) continue;
                ...
                while( RowPos <= dgv.Rows.Count - 1 ) {
                    ...
                    if( tmpTop + CellHeight >= e.MarginBounds.Height + e.MarginBounds.Top ) {
                        ...
                        if( NewPage ) {
                            ...
                            foreach( DataGridViewColumn GridCol in dgv.Columns ) {
                                if( !GridCol.Visible ) continue;
                                if( !Printing.SelectedColumns.Contains( GridCol.HeaderText ) )
                                    continue;
